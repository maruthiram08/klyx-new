...
import { ArrowLeft, ArrowRight, TrendingUp, TrendingDown, Eye } from 'lucide-react';
                      ...
                      >
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex flex-col">
                            <span className="font-bold text-neutral-900">{stock['Stock Name']}</span>
